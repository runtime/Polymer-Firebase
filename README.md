...
Responsive flex images found here:
http://jsbin.com/favisohixe/1/edit?html,output
...
pretty urls
https://github.com/PolymerElements/polymer-starter-kit/blob/master/docs/deploy-to-firebase-pretty-urls.md
